// F3 - Folk ARPS Assign Gear Script - NATO TF 47 Desert
...
_attach2 = "rhsusf_acc_SF3P556";	// Flashlight
...
_oalrig =["rhsusf_spc_squadleader"];
_grenftlrig =["rhsusf_spc_teamleader"];
_corpsmanrig = ["rhsusf_spc_corpsman"];
_marksmanrig = ["rhsusf_spc_marksman"];
_machinegunnersrig = ["rhsusf_spc_iar","rhsusf_spc_mg"];
	...
	case "crate_small":
{
		...
		_unit addMagazineCargoGlobal [_smokegrenade, 8];
		_unit addMagazineCargoGlobal [_smokegrenadegreen, 2];
		_unit addMagazineCargoGlobal [_glflaregreen, 2];
		_unit addMagazineCargoGlobal [_glflareyellow, 2];
		_unit addMagazineCargoGlobal [_glflarered, 2];
	...
	case "crate_med":
{
		...
		_unit addMagazineCargoGlobal [_glflareyellow, 6];
	...
	case "crate_large":
{
		...
		_unit addMagazineCargoGlobal [_glflaregreen, 18];
		_unit addMagazineCargoGlobal [_glflareyellow, 18];
		_unit addMagazineCargoGlobal [_glflarered, 18];
...
// LOADOUT: DEFAULT/UNDEFINED (use RIFLEMAN)
   default
   {
		...
		if (true) exitwith {player globalchat format ["DEBUG (f\assignGear\f_assignGear_nato_tf47_desert.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofunit]};
   };
