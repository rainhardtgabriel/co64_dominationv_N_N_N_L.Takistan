...
_unitFactions = ["blu_f", "opf_f", "ind_f","blu_g_f","opf_g_f","ind_g_f","rhs_faction_insurgents","rhs_faction_msv","rhs_faction_vdv","rhs_faction_vmf","rhs_faction_vv","rhs_faction_tv","rhs_faction_vpvo","rhs_faction_vvs","rhs_faction_vvs_c","rhs_faction_rva","rhs_faction_usarmy_wd","rhs_faction_usarmy_d","rhs_faction_usmc_wd","rhs_faction_usmc_d","rhs_faction_usaf","rhs_faction_usn","rhs_faction_socom"];
