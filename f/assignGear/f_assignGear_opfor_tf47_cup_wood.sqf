// F3 - Folk ARPS Assign Gear Script - OPFOR TF47 Woodland Loadout
...
_silencer1 = "CUP_muzzle_Bizon";	// 5.45 suppressor
_silencer2 = "CUP_muzzle_PBS4";	// 7.62 suppressor

_scope1 = "";						// Ironsight
_scope2 = "CUP_optic_Kobra";			// CCO
_scope3 = "CUP_optic_PSO_1";			// MRCO Scope - 1x - 6x
_scope4 = "CUP_optic_PSO_3";			// SOS Scope - 18x - 75x
...
// Backpacks
_bagsmall = "B_TacticalPack_oli";			// carries 120, weighs 20
...
// Woodland-Hex
_baseUniform = ["CUP_U_O_TK_Green"];
_baseHelmet = ["CUP_H_TK_Helmet"];
_baseGlasses = [];
...
// Vests
_lightRig = ["CUP_V_O_TK_Vest_1"];
_mediumRig = ["CUP_V_O_TK_Vest_1"]; 	// default for all infantry classes
...
_pilotHelmet = ["CUP_H_TK_TankerHelmet"];
_pilotRig = ["CUP_V_O_TK_Vest_1"];
_pilotGlasses = [];
...
if (_isMan) then {
	...
	_unit addItemToVest "ACE_IR_Strobe_Item"; // Adds IR Strobe	
...
// LOADOUT: DEFAULT/UNDEFINED (use RIFLEMAN)
   default
   {
		...
		if (true) exitwith {player globalchat format ["DEBUG (f\assignGear\f_assignGear_opfor_tf47_wood.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofunit]};
   };
