...
f_radios_settings_acre2_groups_blufor = ["Test","Ground Communication Net","Tactical Air Direction Net","Air Control Net","Command and Control Net","Fire Direction Net","Logistics Control Net","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-ray","Yankee","Zulu"];
...
f_radios_settings_acre2_groups_indfor = ["Test","Ground Communication Net","Tactical Air Direction Net","Air Control Net","Command and Control Net","Fire Direction Net","Logistics Control Net","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-ray","Yankee","Zulu"];
