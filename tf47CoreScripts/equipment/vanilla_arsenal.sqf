...
"2B_AssaultPack_rgr_LAT",	//AT Assault Pack 	
...
"U_B_CombatUniform_sgg_tshirt",	//Combat Fatigues (MTP) (Tee) 						
"U_C_Commoner1_2", 	//Commoner Clothes 2 			
"U_C_Commoner1_3", 	//Commoner Clothes 3 	 		
"U_C_Commoner2_1", 	//Commoner Clothes 4 	 		
"U_C_Commoner2_2", 	//Commoner Clothes 5 	 		
"U_C_Commoner2_3", 	//Commoner Clothes 6 	 
"U_C_Farmer", 	//Farmer Clothes 			
"U_C_Fisherman", 	//Fishing Clothes 			
"U_C_FishermanOveralls", 	//Fishing Overalls 					 			
"U_C_HunterBody_brn", 	//Hunting Clothes (Brown) 	 				
"U_IG_Menelaos", 	//Kabeiroi Leader's Outfit 	 			
"U_C_Novak", 	//Novak's Leisure Suit 				
"U_O_SpecopsUniform_blk", 	//Recon Fatigues (Black) 	 		
"U_B_CombatUniform_wdl_vest", 	//Recon Fatigues (MTP) 	 		
"U_B_CombatUniform_sgg_vest", 	//Recon Fatigues (MTP) 			
"U_C_Scavenger_2", 	//Scavenger Clothes (Dark) 			
"U_C_Scavenger_1", 	//Scavenger Clothes (Light) 			
"U_OI_Scientist", 	//Scientist Suit 	 						
"U_B_SpecopsUniform_sgg", 	//Specop Fatigues (Sage) 							
"U_AttisBody", 	//Underwear 4 			
"U_AntigonaBody", 	//Underwear 5 			 	 		
"U_C_WorkerOveralls", 	//Worker Clothes 	 		
"U_B_CombatUniform_mcam_worn", 	//Worn Combat Fatigues (MTP) 	 		
"U_C_Poor_shorts_2", 	//Worn Shorts 2 	 		
