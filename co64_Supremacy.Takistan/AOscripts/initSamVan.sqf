...
for "_i" from 0 to 4 do {
	_newGroup = [_sitePos, east, ["O_APC_Tracked_02_AA_F"]] call BIS_fnc_spawnGroup;
...
// 4x AA Patrol
for "_i" from 0 to 4 do {
	_newGroup = [_sitePos, east, (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam_AA")] call BIS_fnc_spawnGroup;
	[_newGroup,_sitePos, 100] call BIS_fnc_taskPatrol;
	_allObjectsArr pushBack _newGroup;
	sleep 5;
};
