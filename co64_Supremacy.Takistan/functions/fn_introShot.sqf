...
_camera camPrepareTarget [105524.64,24866.81,-1072.92];
_camera camPreparePos [8157.05,2105.99,2.69];
...
_camera camPrepareTarget [-28859.94,-90364.73,-12196.23];
_camera camPreparePos [8308.31,2214.52,16.99];
_camera camPrepareFOV 0.373;
_camera camPrepareBank -10;
...
if (_mode == 0) then {
	...
	if (_fade) then {
		["TF47_fnc_introShot"] call BIS_fnc_blackIn;
	};
