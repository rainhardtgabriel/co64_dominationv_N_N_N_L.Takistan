...
_OPFmen = ["rhs_msv_rifleman","rhs_msv_machinegunner","rhs_msv_medic","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_grenadier","rhs_msv_rifleman","rhs_msv_at","rhs_msv_sergeant","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_at","rhs_msv_rifleman","rhs_msv_grenadier","rhs_msv_grenadier"];
_OPFmen2 = ["rhs_msv_rifleman","rhs_msv_machinegunner","rhs_msv_medic","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_grenadier","rhs_msv_rifleman","rhs_msv_at","rhs_msv_sergeant","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_at","rhs_msv_rifleman","rhs_msv_grenadier","rhs_msv_grenadier"];
