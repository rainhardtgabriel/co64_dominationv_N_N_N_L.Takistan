...

{
	...
	if ([_center1, (_dir + 90), 50, 30, 5, [player,fobcontainer1,fobcontainer2,fobcontainer3]] call tf47_fnc_isFlatEmpty == 1) then
	{
		_angle = _dir;
		_location = _roadPos;
	};
	if ([_center2, (_dir - 90), 50, 30, 5, [player,fobcontainer1,fobcontainer2,fobcontainer3]] call tf47_fnc_isFlatEmpty == 1) then
	{
		_angle = _dir + 180;
		_location = _roadPos;
	};
