...
switch (_mkrtext) do  {
	case "_quad" : {
		...
		spawnveh = [_veh, 60, 1200, "", "mil_dot", "ColorBLUFOR", WEST, "", 1] execVM "tf47CoreScripts\vehicleRespawn.sqf"; 
	...
	case "_tractor" : {
		...
		spawnveh = [_veh, 60, 1200, "Towing Tractor", "mil_dot", "ColorBLUFOR", WEST, "", 1] execVM "tf47CoreScripts\vehicleRespawn.sqf"; 
		_veh setVariable ["R3F_LOG_disabled", true];
		};
	case "_hmmwv_transport" : {
		_veh = [_mkrpos,_mkrdir,_hmmwv_transport] call TF47_VehicleReplacement_fnc_replaceVehicle;
		spawnveh = [_veh, 1800, 7200, " ", "mil_dot", "ColorBLUFOR", WEST, "", 5] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_hmmwv_avenger" : {
		_veh = [_mkrpos,_mkrdir,_hmmwv_avenger] call TF47_VehicleReplacement_fnc_replaceVehicle;
		spawnveh = [_veh, 1800, 7200, "Avenger", "mil_dot", "ColorBLUFOR", WEST, "", 10] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_hmmwv_tow" : {
		_veh = [_mkrpos,_mkrdir,_hmmwv_tow] call TF47_VehicleReplacement_fnc_replaceVehicle;
		spawnveh = [_veh, 1800, 7200, " ", "mil_dot", "ColorBLUFOR", WEST, "", 10] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_hmmwv_mk19" : {
	...
	case "_landrover_transport" : {
		...
		spawnvehspawnveh = [_veh, 1800, 7200, " ", "mil_dot", "ColorBLUFOR", WEST, "", 5] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_jackal2_l2a1" : {
	...
	case "_refuel" : {
		...
		spawnveh = [_veh, 2700, 7200, "Fuel", "mil_dot", "ColorBLUFOR", WEST, "", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_reammo" : {
		_veh = [_mkrpos,_mkrdir,_reammo] call TF47_VehicleReplacement_fnc_replaceVehicle; 
		spawnveh = [_veh, 2700, 7200, "Reammo", "mil_dot", "ColorBLUFOR", WEST, "", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_repair" : {
		_veh = [_mkrpos,_mkrdir,_repair] call TF47_VehicleReplacement_fnc_replaceVehicle; 
		spawnveh = [_veh, 2700, 7200, "Repair", "mil_dot", "ColorBLUFOR", WEST, "", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_transport" : {
		_veh = [_mkrpos,_mkrdir,_transport] call TF47_VehicleReplacement_fnc_replaceVehicle; 
		spawnveh = [_veh, 2700, 7200, "Transport", "mil_dot", "ColorBLUFOR", WEST, "", 8] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_ambulance" : {
		_veh = [_mkrpos,_mkrdir,_ambulance] call TF47_VehicleReplacement_fnc_replaceVehicle;
		spawnveh = [_veh, 1800, 7200, "Ambulance", "mil_dot", "ColorRed", WEST, "", 10] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_hmmwv_toc" :{
		...
		spawnveh = [tochmmwv, 1800, 7200, "TOC", "mil_dot", "ColorBLUFOR", WEST, "", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_rhino01" : {
		rhino1 = [_mkrpos,_mkrdir,_rhino01] call TF47_VehicleReplacement_fnc_replaceVehicle; 
		spawnveh = [rhino1, 3600, 0, "RHINO-01", "b_mech_inf", "ColorOrange", WEST, "harmor", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_rhino02" : {
		rhino2 = [_mkrpos,_mkrdir,_rhino02] call TF47_VehicleReplacement_fnc_replaceVehicle;
		spawnveh = [rhino2, 3600, 0, "RHINO-02", "b_mech_inf", "ColorOrange", WEST, "harmor", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_lion01": {
		lion1 = [_mkrpos,_mkrdir,_lion01] call TF47_VehicleReplacement_fnc_replaceVehicle;
		spawnveh = [lion1, 3600, 0, "LION-01", "b_mech_inf", "ColorOrange", WEST, "harmor", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_lion02" : {
		lion2 = [_mkrpos,_mkrdir,_lion02] call TF47_VehicleReplacement_fnc_replaceVehicle;
		//_veh setVariable [ "lion2",lion2,true];
		spawnveh = [lion2, 3600, 0, "LION-02", "b_mech_inf", "ColorOrange", WEST, "harmor", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_frog01" : {
		frog1 = [_mkrpos,_mkrdir,_frog01] call TF47_VehicleReplacement_fnc_replaceVehicle;
		//_veh setVariable [ "frog1",rhino1,true];
		spawnveh = [frog1, 3600, 0, "FROG-01", "b_mech_inf", "ColorOrange", WEST, "harmor", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_tiger01" : 		{
		tiger1 = [_mkrpos,_mkrdir,_tiger01] call TF47_VehicleReplacement_fnc_replaceVehicle;
		//_veh setVariable [ "tiger1";
		spawnveh = [tiger1, 2700, 0, "TIGER-01", "b_mech_inf", "ColorOrange", WEST, "larmor", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_tiger02" :		{
		tiger2 = [_mkrpos,_mkrdir,_tiger02] call TF47_VehicleReplacement_fnc_replaceVehicle;
		//_veh setVariable [ "tiger2";
		spawnveh = [tiger2, 2700, 0, "TIGER-02", "b_mech_inf", "ColorOrange", WEST, "larmor", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_tiger03" : 		{
		tiger3 = [_mkrpos,_mkrdir,_tiger03] call TF47_VehicleReplacement_fnc_replaceVehicle; 
		//_veh setVariable [ "tiger3";
		spawnveh = [tiger3, 2700, 0, "TIGER-03", "b_mech_inf", "ColorOrange", WEST, "larmor", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_gator01" : 		{
		gator1 = [_mkrpos,_mkrdir,_gator01] call TF47_VehicleReplacement_fnc_replaceVehicle; 
		//_veh setVariable [ "gator1";
		spawnveh = [gator1, 2700, 0, "GATOR-01", "b_mech_inf", "ColorOrange", WEST, "larmor", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_gator02" : 		{
		gator2 = [_mkrpos,_mkrdir,_gator02] call TF47_VehicleReplacement_fnc_replaceVehicle;
		//_veh setVariable [ "gator2";
		spawnveh = [gator2, 2700, 0, "GATOR-02", "b_mech_inf", "ColorOrange", WEST, "larmor", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
		};
	case "_butterfly01" : 	{
		butterfly1 = [_mkrpos,_mkrdir,_butterfly01] call TF47_VehicleReplacement_fnc_replaceVehicle;
		//_veh setVariable [ "butterfly1";
		spawnveh = [butterfly1, 1800, 0, "BUTTERFLY-01", "b_air", "ColorBrown", WEST, "rottrans", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_butterfly02" : 	{
		...
		//_veh setVariable [ "butterfly2";
		spawnveh = [butterfly2, 1800, 0, "BUTTERFLY-02", "b_air", "ColorBrown", WEST, "rottrans", 15] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_firefly" : 		{
		...
		//_veh setVariable [ "manticore1";
		spawnveh = [firefly1, 2700, 0, "FIREFLY", "b_air", "ColorOrange", WEST, "rotatk", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_manticore" : 	{
		...
		//_veh setVariable [ "manticore1";
		spawnveh = [manticore1, 2700, 0, "MANTICORE", "b_air", "ColorOrange", WEST, "rotatk", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_griffin" : 		{
		...
		//_veh setVariable [ "griffin1";
		spawnveh = [griffin1, 2700, 0, "GRIFFIN", "b_air", "ColorBrown", WEST, "rottrans", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_raven01" : 		{
		...
		//_veh setVariable [ "raven1";
		spawnveh = [raven1, 2700, 0, "RAVEN-01", "b_air", "ColorBrown", WEST, "rottrans", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_raven02" : 		{
		...
		//_veh setVariable [ "raven2";
		spawnveh = [raven2, 2700, 0, "RAVEN-02", "b_air", "ColorBrown", WEST, "rottrans", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_dustoff" : 		{
		...
		//_veh setVariable [ "dustoff";
		spawnveh = [dustoff, 2700, 0, "DUSTOFF", "b_air", "ColorRed", WEST, "rottrans", 30] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_pelican" : 		{
		...
		//_veh setVariable [ "pelican1";
		spawnveh = [pelican1, 3600, 0, "PELICAN", "b_air", "ColorBrown", WEST, "rottrans", 20] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_goose" : 		{
		...
		// _veh setVariable [ "goose1",true];
		spawnveh = [goose1, 2700, 0, "GOOSE", "b_air", "ColorBrown", WEST, "rottrans", 30] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_albatros" : 		{
		...
		// _veh setVariable [ "albatros1",true];
		spawnveh = [albatros1, 2700, 0, "ALBATROS", "b_plane", "ColorOrange", WEST, "fixatk", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_wasp01" : 		{
		...
		// _veh setVariable [ "wasp1",true];
		spawnveh = [wasp1, 2700, 0, "WASP-01", "b_plane", "ColorOrange", WEST, "fixatk", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_wasp02" : 		{
		...
		// _veh setVariable [ "wasp2",true];
		spawnveh = [wasp2, 2700, 0, "WASP-02", "b_plane", "ColorOrange", WEST, "fixatk", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
	...
	case "_thunderbird" :	{
		...
		// _veh setVariable [ "thunderbird1",true];
		spawnveh = [thunderbird1, 2700, 0, "THUNDERBIRD", "b_plane", "ColorOrange", WEST, "fixatk", 25] execVM "tf47CoreScripts\vehicleRespawn.sqf";
