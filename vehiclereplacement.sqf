...
switch (_mkrtext) do  {
	...
	case "_rhino01" : {
		...
		rhino1 setVehicleVarName "rhino1";
		};
	case "_rhino02" : {
		...
		rhino2 setVehicleVarName "rhino2";
		};
	case "_lion01": {
	...
	case "_tiger01" : 		{
		...
		tiger1 setVehicleVarName "tiger1";
		};
	case "_tiger02" :		{
	...
	case "_tiger03" : 		{
		...
		tiger3 setVehicleVarName "tiger3";
		};
	case "_gator01" : 		{
		...
		gator1 setVehicleVarName "gator1";
		};
	case "_gator02" : 		{
		...
		gator2 setVehicleVarName "gator2";
		};
	case "_butterfly01" : 	{
		...
		butterfly1 setVehicleVarName "butterfly1";
		};
	case "_butterfly02" : 	{
		...
		butterfly2 setVehicleVarName "butterfly2";
		};
	case "_firefly" : 		{
		...
		firefly1 setVehicleVarName "firefly1";
		};
	case "_manticore" : 	{
		...
		manticore1 setVehicleVarName "manticore1";
		};
	case "_griffin" : 		{
		...
		griffin1 setVehicleVarName "griffin1";
		};
	case "_raven01" : 		{
		...
		raven1 setVehicleVarName "raven1";
		};
	case "_raven02" : 		{
		...
		raven2 setVehicleVarName "raven2";
		};
	case "_dustoff" : 		{
		...
		dustoff setVehicleVarName "dustoff";
		};
	case "_pelican" : 		{
		...
		pelican1 setVehicleVarName "pelican1";
		};
	case "_goose" : 		{
		...
		goose1 setVehicleVarName "goose1";
		};
	case "_albatros" : 		{
		...
		albatros1 setVehicleVarName "albatros1";
		};
	case "_wasp01" : 		{
	...
	case "_thunderbird" :	{
		...
		thunderbird1 setVehicleVarName "thunderbird1";
		};
	case "_evileye" :	{
		...
		evileye1 setVehicleVarName "evileye1";
		};
	case "_basedef_tank" : {
